...
CATEGORY_MAP = {
    ...
    # dopiszesz kolejne:
    # "https://...": "DokładnaNazwaKategorii/DokładnaNazwaPodkategorii",
}
...
def json_to_csv(input_json: Path, output_csv: Path, target_subcategory_url: str, vat_rate: float = 0.23):
    ...
    for cat, sub, p in iter_products(data):
        ...
        # if len(image_urls) == 0:
        #     continue  # albo ustaw domyślne zdjęcie, ale najlepiej pominąć na start
        # images_field = ",".join(image_urls[:2])  # masz 2 zdjęcia — super

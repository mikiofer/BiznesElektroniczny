 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qt}=window;class Lt{constructor(){this.router=new yt}refresh(e){qt.ajax(this.router.generate("admin_orders_get_discounts",{orderId:e})).then((e=>{qt(Ze.list).replaceWith(e)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
class Mt{calculateTaxExcluded(e,t,r){let o=e;(o<0||Number.isNaN(o))&&(o=0);const s=t/100+1;return window.ps_round(o/s,r)}calculateTaxIncluded(e,t,r){let o=e;(o<0||Number.isNaN(o))&&(o=0);const s=t/100+1;return window.ps_round(o*s,r)}calculateTotalPrice(e,t,r){return window.ps_round(t*e,r)}}var jt=r(428),At=Object.defineProperty,Ft=Object.getOwnPropertySymbols,Dt=Object.prototype.hasOwnProperty,$t=Object.prototype.propertyIsEnumerable,Nt=(e,t,r)=>t in e?At(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Gt=(e,t)=>{for(var r in t||(t={}))Dt.call(t,r)&&Nt(e,r,t[r]);if(Ft)for(var r of Ft(t))$t.call(t,r)&&Nt(e,r,t[r]);return e};
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:kr}=window;class Er{constructor(){this.router=new yt}addOrUpdateProductToList(e,t){e.length>0?e.html(kr(t).html()):kr(be).before(kr(t).hide().fadeIn())}updateNumProducts(e){kr(Q).html(e)}editProductFromList(e,t,r,o,s,n,i,d,a,c){new Tr(e).displayProduct({price_tax_excl:o,price_tax_incl:r,tax_rate:s,quantity:t,location:n,availableQuantity:i,availableOutOfStock:d,orderInvoiceId:a,isOrderTaxIncluded:c}),kr(ge).addClass("d-none"),kr(be).addClass("d-none")}moveProductsPanelToModificationPosition(e="body"){kr(fe).addClass("d-none"),kr(`${ge}, ${be}`).removeClass("d-none"),this.moveProductPanelToTop(e)}moveProductsPanelToRefundPosition(){this.resetAllEditRows(),kr(`${ge}, ${be}, ${fe}`).addClass("d-none"),this.moveProductPanelToTop()}moveProductPanelToTop(e="body"){const t=kr(z);if(t.find(U).length>0)return;kr(U).detach().appendTo(t),t.removeClass("d-none"),this.toggleColumn(de),this.toggleColumn(ae);kr(J).find('tr[id^="orderProduct_"]').removeClass("d-none"),kr(W).addClass("d-none");const r=kr(e).offset(),o=kr(".header-toolbar").height();if(r&&o){const e=r.top-o-100;kr("html,body").animate({scrollTop:e},"slow")}}moveProductPanelToOriginalPosition(){kr(Le).addClass("d-none"),kr(z).addClass("d-none"),kr(U).detach().appendTo(H),kr(W).removeClass("d-none"),kr(fe).removeClass("d-none"),kr(`${ge}, ${be}`).addClass("d-none"),this.paginate(1)}resetAddRow(){kr(Ie).val(""),kr(_e).val(""),kr(Pe).addClass("d-none"),kr(we).val(""),kr(we).prop("disabled",!1),kr(Te).val(""),kr(ke).val(""),kr(Ee).val(""),kr(Se).html(""),kr(Oe).html(""),kr(Le).addClass("d-none"),kr(ge).prop("disabled",!0)}resetAllEditRows(){kr(he).each(((e,t)=>{this.resetEditRow(kr(t).data("orderDetailId"))}))}resetEditRow(e){const t=kr(se(e));kr(ne(e)).remove(),t.removeClass("d-none")}paginate(e){const t=kr(J).find('tr[id^="orderProduct_"]'),r=kr(ue),o=kr(Z),s=parseInt(o.data("numPerPage"),10),n=Math.ceil(t.length/s),i=Math.max(1,Math.min(e,n));this.paginateUpdateControls(i),t.addClass("d-none"),r.addClass("d-none");const d=i*s;for(let e=(i-1)*s+1-1;e<Math.min(d,t.length);e+=1)kr(t[e]).removeClass("d-none");r.each((function(){kr(this).prev().hasClass("d-none")||kr(this).removeClass("d-none")})),kr(Fe).not(Ae).remove(),this.toggleColumn(ce),this.toggleColumn(le)}paginateUpdateControls(e){const t=kr(Z).find("li.page-item").length-3;kr(Z).find(".active").removeClass("active"),kr(Z).find(`li:has(> [data-page="${e}"])`).addClass("active"),kr(Y).removeClass("disabled"),1===e&&kr(Y).addClass("disabled"),kr(X).removeClass("disabled"),e===t&&kr(X).addClass("disabled"),this.togglePaginationControls()}updateNumPerPage(e){kr(Z).data("numPerPage",e),this.updatePaginationControls()}togglePaginationControls(){const e=kr(Z).find("li.page-item").length-3;kr(K).toggleClass("d-none",e<=1)}toggleProductAddNewInvoiceInfo(){kr(Le).toggleClass("d-none",0!==parseInt(kr(Ce).val(),10))}toggleColumn(e,t=null){let r=!1;null===t?kr(e).filter("td").each((function(){if(""!==kr(this).html())return r=!0,!1})):r=t,kr(e).toggleClass("d-none",!r)}updatePaginationControls(){const e=kr(Z),t=e.data("numPerPage"),r=kr(J).find('tr[id^="orderProduct_"]'),o=Math.ceil(r.length/t);e.data("numPages",o);const s=kr(re);kr(Z).find("li:has(> [data-page])").remove(),kr(X).before(s);for(let e=1;e<=o;e+=1){const t=s.clone();t.find("span").attr("data-page",e),t.find("span").html(e),s.before(t.removeClass("d-none"))}this.togglePaginationControls()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Sr}=window;class Or{constructor(){this.router=new yt}refresh(e){Sr.ajax(this.router.generate("admin_orders_get_payments",{orderId:e})).then((e=>{Sr(i).remove(),Sr(`${n} .card-body`).prepend(e)}),(e=>{e.responseJSON&&e.responseJSON.message&&Sr.growl.error({message:e.responseJSON.message})}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Rr}=window;class Cr{constructor(){this.router=new yt}refresh(e){Rr.getJSON(this.router.generate("admin_orders_get_shipping",{orderId:e})).then((e=>{Rr(D).text(e.total),Rr($).html(e.html)}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:qr}=window;class Lr{constructor(){this.router=new yt}refresh(e){qr.getJSON(this.router.generate("admin_orders_get_invoices",{orderId:e})).then((e=>{if(!e||!e.invoices||Object.keys(e.invoices).length<=0)return;const t=qr(s),r=qr(Ce).find("optgroup:first"),o=qr(Qe),n=qr(h);r.empty(),t.empty(),o.empty(),n.empty(),Object.keys(e.invoices).forEach((s=>{const i=e.invoices[s],d=s.split(" - ")[0];r.append(`<option value="${i}">${d}</option>`),t.append(`<option value="${i}">${d}</option>`),o.append(`<option value="${i}">${d}</option>`),n.append(`<option value="${i}">${s}</option>`)}));const i=document.querySelector(Ce);i&&(i.selectedIndex=0)}))}}var Mr=r(5834);
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:jr}=window;class Ar{constructor(){this.router=new yt,this.cancelProductForm=jr(dt.form),this.orderId=this.cancelProductForm.data("orderId"),this.orderDelivered=1===parseInt(this.cancelProductForm.data("isDelivered"),10),this.isTaxIncluded=1===parseInt(this.cancelProductForm.data("isTaxIncluded"),10),this.discountsAmount=parseFloat(this.cancelProductForm.data("discountsAmount")),this.currencyFormatter=Mr.NumberFormatter.build(this.cancelProductForm.data("priceSpecification")),this.useAmountInputs=!0,this.listenForInputs()}showPartialRefund(){this.hideCancelElements(),jr(dt.toggle.partialRefund).show(),this.useAmountInputs=!0,this.initForm(jr(dt.buttons.save).data("partialRefundLabel"),this.router.generate("admin_orders_partial_refund",{orderId:this.orderId}),"partial-refund")}showStandardRefund(){this.hideCancelElements(),jr(dt.toggle.standardRefund).show(),this.useAmountInputs=!1,this.initForm(jr(dt.buttons.save).data("standardRefundLabel"),this.router.generate("admin_orders_standard_refund",{orderId:this.orderId}),"standard-refund")}showReturnProduct(){this.hideCancelElements(),jr(dt.toggle.returnProduct).show(),this.useAmountInputs=!1,this.initForm(jr(dt.buttons.save).data("returnProductLabel"),this.router.generate("admin_orders_return_product",{orderId:this.orderId}),"return-product")}hideRefund(){this.hideCancelElements(),jr(dt.table.actions).show()}hideCancelElements(){jr(dt.toggle.standardRefund).hide(),jr(dt.toggle.partialRefund).hide(),jr(dt.toggle.returnProduct).hide(),jr(dt.table.actions).hide()}initForm(e,t,r){this.updateVoucherRefund(),this.cancelProductForm.prop("action",t),this.cancelProductForm.removeClass("standard-refund partial-refund return-product cancel-product").addClass(r),jr(dt.buttons.save).html(e),jr(dt.table.header).html(e),jr(dt.checkboxes.restock).prop("checked",this.orderDelivered),jr(dt.checkboxes.creditSlip).prop("checked",!0),jr(dt.checkboxes.voucher).prop("checked",!1)}listenForInputs(){jr(document).on("change",dt.inputs.quantity,(e=>{const t=jr(e.target),r=t.parents(dt.table.cell).find(dt.inputs.amount),o=parseInt(t.val(),10);if(o<=0)return r.val(0),void this.updateVoucherRefund();const s=this.isTaxIncluded?"productPriceTaxIncl":"productPriceTaxExcl",n=parseFloat(t.data(s)),i=parseFloat(t.data("amountRefundable")),d=n*o<i?n*o:i,a=parseFloat(r.val());this.useAmountInputs&&this.updateAmountInput(t),(""===r.val()||0===a||a>d)&&(r.val(d),this.updateVoucherRefund())})),jr(document).on("change",dt.inputs.amount,(()=>{this.updateVoucherRefund()})),jr(document).on("change",dt.inputs.selector,(e=>{const t=jr(e.target),r=t.parents(dt.table.cell).find(dt.inputs.quantity),o=parseInt(r.data("quantityRefundable"),10),s=parseInt(r.val(),10);t.is(":checked")?(Number.isNaN(s)||0===s)&&r.val(o):r.val(0),this.updateVoucherRefund()}))}updateAmountInput(e){const t=e.parents(dt.table.cell).find(dt.inputs.amount),r=parseInt(e.val(),10);if(r<=0)return void t.val(0);const o=this.isTaxIncluded?"productPriceTaxIncl":"productPriceTaxExcl",s=parseFloat(e.data(o)),n=parseFloat(e.data("amountRefundable")),i=s*r<n?s*r:n,d=parseFloat(t.val());(""===t.val()||0===d||d>i)&&t.val(i)}getRefundAmount(){let e=0;return this.useAmountInputs?jr(dt.inputs.amount).each(((t,r)=>{const o=parseFloat(r.value);e+=Number.isNaN(o)?0:o})):jr(dt.inputs.quantity).each(((t,r)=>{const o=jr(r),s=this.isTaxIncluded?"productPriceTaxIncl":"productPriceTaxExcl",n=parseFloat(o.data(s)),i=parseInt(o.val(),10);e+=i*n})),e}updateVoucherRefund(){const e=this.getRefundAmount();this.updateVoucherRefundTypeLabel(jr(dt.radios.voucherRefundType.productPrices),e);const t=e-this.discountsAmount;this.updateVoucherRefundTypeLabel(jr(dt.radios.voucherRefundType.productPricesVoucherExcluded),t),t<0?(jr(dt.radios.voucherRefundType.productPricesVoucherExcluded).prop("checked",!1).prop("disabled",!0),jr(dt.radios.voucherRefundType.productPrices).prop("checked",!0),jr(dt.radios.voucherRefundType.negativeErrorMessage).show()):(jr(dt.radios.voucherRefundType.productPricesVoucherExcluded).prop("disabled",!1),jr(dt.radios.voucherRefundType.negativeErrorMessage).hide())}updateVoucherRefundTypeLabel(e,t){var r;const o=e.data("defaultLabel"),s=e.parents("label"),n=this.currencyFormatter.format(t),i=null==(r=null==s?void 0:s.get(0))?void 0:r.lastChild;i&&(i.nodeValue=`\n      ${o} ${n}`)}showCancelProductForm(){const e=this.router.generate("admin_orders_cancellation",{orderId:this.orderId});this.initForm(jr(dt.buttons.save).data("cancelLabel"),e,"cancel-product"),this.hideCancelElements(),jr(dt.toggle.cancelProducts).show()}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Fr}=window;class Dr{constructor(){this.router=new yt,this.invoiceNoteManager=new vt}refresh(e){Fr.getJSON(this.router.generate("admin_orders_get_documents",{orderId:e})).then((e=>{Fr(A).text(e.total),Fr(F).html(e.html),this.invoiceNoteManager.setupListeners()}))}}
/**
 * Copyright since 2007 PrestaShop SA and Contributors
 * PrestaShop is an International Registered Trademark & Property of PrestaShop SA
 *
 ...
 * @license   https://opensource.org/licenses/OSL-3.0 Open Software License (OSL 3.0)
 */
const{$:Vr}=window;Vr((()=>{const r="percent",o="free_shipping";new ft,window.prestashop.component.initComponents(["TextWithLengthCounter"]);const s=new Nr,n=new Br(Vr(_e)),i=new zr;s.listenForProductPack(),s.listenForProductDelete(),s.listenForProductEdit(),s.listenForProductAdd(),s.listenForProductPagination(),s.listenForRefund(),s.listenForCancelProduct(),n.listenForSearch(),n.onItemClickedCallback=e=>i.setProduct(e),Vr(t).on("click",(e=>{Vr(e.currentTarget).closest("tr").next(":first").toggleClass("d-none")})),function(){const e=Vr(l);Vr(c).on("input",(()=>{e.prop("disabled",!1)}))}(),function(){const e=Vr(ht);Vr(ut).on("input",(()=>{e.prop("disabled",!1)}))}(),function(){const e=Vr(x),t=Vr(y);Vr(I).on("change",(r=>{const o=Vr(r.currentTarget),s=Vr("option:selected",o),n=o.val();t.css("background-color",s.data("background-color")),t.toggleClass("is-bright",void 0!==s.data("is-bright")),e.prop("disabled",parseInt(n,10)===e.data("orderStatusId"))}))}(),new vt;const P=new Qr;P.listenForPredefinedMessageSelection(),P.listenForFullMessagesOpen(),Vr(d).on("click",(e=>{e.preventDefault(),function(){const e=Vr(a),t=Vr(d),r=t.hasClass("is-opened");r?(t.removeClass("is-opened"),e.addClass("d-none")):(t.addClass("is-opened"),e.removeClass("d-none"));t.find(".material-icons").text(r?"add":"remove")}()})),Vr(ct).on("click",(e=>{e.preventDefault(),function(){const e=Vr(lt),t=Vr(ct),r=t.hasClass("is-opened");t.toggleClass("is-opened",!r),e.toggleClass("d-none",r);t.find(".material-icons").text(r?"add":"remove")}()})),Vr(at).on("click",(()=>{const t=document.title;document.title=Vr(e).data("orderTitle"),window.print(),document.title=t})),function(){const e=Vr(u),t=e.find("form"),s=e.find(h),n=e.find(_),i=t.find(f),d=i.closest(".form-group");e.on("shown.bs.modal",(()=>{Vr(v).prop("disabled",!0)})),e.on("hidden.bs.modal",(()=>{Vr(p).val(""),Vr(m).val(r).trigger("change"),Vr(f).val("")})),t.find(p).on("keyup",(e=>{const t=Vr(e.currentTarget).val();Vr(v).prop("disabled",0===t.trim().length)})),t.find(b).on("change",(e=>{const t=Vr(e.currentTarget).is(":checked");s.prop("disabled",t)})),t.find(m).on("change",(e=>{const s=Vr(e.currentTarget).val(),a=t.find(g);"amount"===s?(n.removeClass("d-none"),a.html(a.data("currencySymbol"))):n.addClass("d-none"),s===r&&a.html("%"),i.prop("disabled",s===o),d.toggleClass("d-none",s===o)}))}(),function(){const e=Vr(E);Vr(S).on("click",(t=>{e.find(O).val(Vr(t.currentTarget).data("addressType"))}))}(),Vr(it).find(".nav-tabs li:first-child a").tab("show")}))})(),window.order_view={}})();